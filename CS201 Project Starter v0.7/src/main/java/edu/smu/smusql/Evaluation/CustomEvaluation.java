...
public class CustomEvaluation {
    ...
    private static String generateComplexSelectQuery(Random random) {
        ...
        String[] orderConditions = {"quantity > 5", "quantity < 25", "quantity > 50", "quantity < 50"};
    ...
    private static String generateComplexDeleteQuery(Random random) {
        ...
        switch (tableName) {
            ...
            case "users":
                ...
                break;
            case "products":
                conditions.add(generateCondition("price", random.nextDouble() * 500 + 100, random.nextBoolean() ? ">" : "<"));
